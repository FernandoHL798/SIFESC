...
<html lang="en">
  <head>
    ...
    <style>
            .bg {
          background-image: url(imgs/UNAM_Fondo.jpg);
      ...
      <div class="row g-0 align-items-stretch">
        ...
        <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
          <div class="px-lg-5 pt-lg-4 pb-lg-3 p-4 w-100 mb-auto">
            <img src="imgs/UNAM.jpg" class="img-fluid" width="120">
          </div>
          <div class="px-lg-5 pt-lg-4 p-4 w-100 align-self-center mb-4">
            <h1 class="mb-4">Verifica tu identidad</h1>
            <form>
              <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input type="password" class="form-control mb-2" placeholder="ddmmaaaa" id="exampleInputfnacimiento">
              </div>
              <div class="mb-4">
                <label for="exampleInputCPostal" class="form-label font-weight-bold">Código Postal</label>
                <input type="email" class="form-control" placeholder="XXXXX" id="exampleInputCPostal" aria-describedby="emailHelp">
              </div>
              <div>
                <form action="../../form-result.php" target="_blank">
                  <p>
                    Sexo:<br>
                    <center><input type="radio" name="sexo" value="Masculino">Masculino &nbsp; &nbsp;
                      <input type="radio" name="sexo" value="Femenino">Femenino<br></center>
                  </p>
                </form>
              </div>
