            ...
            <form id="frm-verifica-contra">
              ...
              <div class="row">      
                ...
                <div class="row">
                  <div class="col-5 mx-auto">
                    <label for="psw"></label>
                    <input type="password" class="form-control mb-2" placeholder="Ingresa tu nueva contraseña:" required id="psw" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" maxlength="25" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                ...
                <div class="row">
                  <div class="col-5 mx-auto">
                    <input type="password" class="form-control mb-2" maxlength="25" placeholder="Confirma tu nueva contraseña:" required id="exampleInputPassword1">
                  </div>
                </div>
                <div class="mt-3 mb-2"></div>
