        ...
        <div class="modal-body">
          ...
          <div class="form-group" id="actual-pass-group">
            <div class="form-group">
              <input type="text" minlength="5" pattern="[0-9]{4}[A-Z]{1}" minlength="1" maxlength="5" placeholder="Grupo: " class="form-control" style="height: 60px" id="grupo_agrega" name="grupo_agrega" onkeydown="verificarVacioGrupo();" onkeyup="verificarVacioGrupo();" onfocus="verificarVacioGrupo();">
            </div>
            <div class="mt-3 mb-2"></div>
