                  ...
                  <div class="form-group" id="actual-pass-group">
                      <div class="form-group">
                        <label for="clave_asignatura">Clave:</label>
                          ...
                          <input type="text" maxlength="4" pattern="[0-9]{4}" placeholder="Clave:" class="form-control" style="height: 45px" id="clave_asignatura_add" name="clave_asignatura_add" onkeydown="verificavacioag()" onkeyup="verificavacioag()" onblur="verificavacioag()" onfocus="verificavacioag()" title="Debe contener 4 caracteres">
                      ...
                      <div class="form-floating">
                        ...
                        <div class="form-group" id="">
                          ...
                          <input type="number" min="2" max="12" placeholder="Créditos:" class="form-control" style="height: 45px" id="creditos_add" name="creditos_add" onkeydown="verificavacioag()" onkeyup="verificavacioag()" onblur="verificavacioag()" onfocus="verificavacioag()">
                        </div>
                          <div>
