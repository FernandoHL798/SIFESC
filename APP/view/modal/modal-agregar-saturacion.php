                ...
                <div class="modal-dialog">
                    ...
                    <form id="frm_m_a_saturacion">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-floating">
                          <select class="form-select" id="grupos" name="grupos">
                              <option hidden=""></option>
                              <option value="1">1102</option>
                              <option value="2">2102</option>
                              <option value="3">3102</option>
                          </select>
                              <label for="grupos"><font SIZE=3.5>Grupo:</font></label>
                  </div>
                  <div class="mt-3 mb-2"></div>
                  ...
                  <div class="form-floating">
                          <select class="form-select" id="semestre" name="semestre">
                              ...
                              <label for="semestre"><font SIZE=3.5>Semestre:</font></label>
                  </div>
                  <div class="mt-3 mb-2"></div>
                        <div class="form-group">
