...
<body id="body">
    ...
    <div class="home_content2">
        <div class="texthome">
            <form class="mb-4">              
                <div class="mb-4">
                    ...
                    <p class="text-center mb-5">Agrega los nuevos periodos. <br> El sistema para todos los usuarios se basara en el periodo activo. <br> Solo se puede tener activo un periodo a la vez. <br>Las fechas para consultar la dosificación son generales para todos los planes de estudio </p>
        ...
        <p>SE ESTA ANALIZANDO LAS PANTALLAS DEL PERIODO, JUNTA CON FERNANDO Y NAYE (EMH)</p>
    </div>
</form>   
</div>
</div>
